...
mexFunction (int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[])
{
  ...
  if (nrhs != 8) {
    mexErrMsgTxt
      ("mexDetEstCircle_Complete: 8 input arguments are required!");
  }
  if (nlhs != 4 && nlhs != 6 && nlhs != 7) {
    mexErrMsgTxt
      ("mexDetEstCircle_Complete: 4 or 6 or 7 output arguments required!");
  }
  ...
  if (mxGetNumberOfElements (prhs[1]) != num_points) {
    mexErrMsgTxt
      ("mexDetEstCircle_Complete: x and y do not have the same length!");
  }
  ...
  if (!(CppDetEstCircle4 (x, y,
                          ...
                          ArcInfo, finalx, finaly, DebugInfo)
      )) {
    mexErrMsgTxt
      ("mexDetEstCircle_Complete: C++ style function: CppDetEstCircle failed!");
  }
