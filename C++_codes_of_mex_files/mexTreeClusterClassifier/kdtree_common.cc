...
// format revised by Zhan Li, 2010-3
...
//
// [LZ] pVertex points to a tree, model is matrix of points whose nearest points in the tree to be searched.
//		M is number of points in model, D is the number of dimension of points. 
//		closest_pt records the closest points (either pointer of closest points or their index, up to ReturnType)
//		distance records the distance of points in model to their corresponding closest points. 
